...
# parallel -a 02_infos/ind_ALL.txt -k -j 10 srun -c 1 -J 03_genotype_{} -log/03_genotype_{}_%j.log /bin/sh 01_scripts/03_genotype.sh {} &
...
delly call -g $GENOME -v $CALLS_DIR/merged_sites.bcf -o $CALLS_DIR/geno/"$sample_ID".geno.bcf $SAMPLE
