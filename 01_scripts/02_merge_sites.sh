...
# srun -p small -J 02_merge_sites -o log/02_merge_sites_%j.log /bin/sh 01_scripts/02_merge_sites.sh &
...
ls -1 $CALLS_DIR/raw/*.bcf > $BCF_LIST

# 2. Merge SV sites into a unified site list
delly merge -o $CALLS_DIR/merged_sites.bcf $BCF_LIST
