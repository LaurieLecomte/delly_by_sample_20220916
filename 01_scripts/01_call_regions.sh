...
# parallel -a 02_infos/ind_ALL.txt -k -j 10 srun -c 1 --mem=20G -p medium --time=7-00:00 -J 01_call_regions_{} -o log/01_call_regions_{}_%j.log /bin/sh 01_scripts/01_call_regions_M.sh {} &
